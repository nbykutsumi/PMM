...
for [nallmin, nallmax] in lthnall:
    ...
    for idx_db in lidx_db:
        ...
        for idx_db_expand in lidx_db_expand:
            ...
            a2epcdb.append(db.get_var('pc_emis', nrec=DB_MAXREC)[:,:NEM])  # (nrec, 12)
            a1prec .append(db.get_var('precip_NS_cmb', nrec=DB_MAXREC))
            a1t2m  .append(db.get_var('t2m', nrec=DB_MAXREC))
