...
dargv['oid'] = 1453
dargv['clat'] = 33.5   # center latitude. Set to -9999 for global
dargv['clon'] = -152.7 # center longitude. Set to -9999 for global
dargv['dlatlon'] = 3 # parameter for center location searching (degree). Set to -9999 for global
dargv['iscan'] = -9999
dargv['escan'] = -9999
dargv['dscan'] = 20  # dscan*2 = number of retrieved scans. Set to -9999 for global


dargv['srcPath'] = './1C.GPM.GMI.XCAL2016-C.20140601-S010534-E023807.001453.V05A.HDF5'  # L1C TB file
dargv['s2xPath'] = './2014/06/01/Xpy.1.001453.npy'
dargv['s2yPath'] = './2014/06/01/Ypy.1.001453.npy'
dargv['t2mPath'] = ''
dargv['tqvPath'] = ''
dargv['elevPath']= ''
dargv['stopPath']= ''
...
prog = './ret-epc-multi.2020.07.20.py'
