...
for lgmiPath in llgmiPath:
    ...
    for gmiPath in lgmiPath:
        ...
        try:
            ...
            loid.pop(-1)
            continue
        #print tankDir + '/utsumi/PMM/retepc/glb.v03.minrec1000.maxrec10000/%04d/%02d/%02d/nsurfNScmb.%06d.y-9999--9999.nrec10000.npy'%(Year,Mon,Day,oid)
    ...
    #----------------------------
    oid0 = lgmiPath[0].split('.')[-3]
    oid1 = lgmiPath[-1].split('.')[-3]
