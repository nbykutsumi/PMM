...
for (yyyy,mm,dd,oid) in lorbit:
    ...
    lonPath = '/mnt/j/PMM/MATCH.GMI.V05A/S1.ABp103-117.GMI.Longitude/%04d/%02d/%02d/Longitude.%06d.npy'%(yyyy,mm,dd,oid)
    t2mPath = '/mnt/j/PMM/MATCH.GMI.V05A/S1.ABp000-220.MERRA2.t2m/%04d/%02d/%02d/t2m.%06d.npy'%(yyyy,mm,dd,oid)
    ...
    # Save
    #******************************************
    figPath = '/mnt/c/ubuntu/fig/fig.stop.map.png'
    pl.savefig(figPath)
    print figPath 
