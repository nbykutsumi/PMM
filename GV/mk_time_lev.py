...
for idt, dt in enumerate(range(offset_bef, offset_aft+1)):
    ...
    dagvall    = {ih:deque([]) for ih in range(nh)}
    dagvgd     = {ih:deque([]) for ih in range(nh)}
    ...
    for domain in ldomain:
        for YM in lYM:
            ...
            #agvall = np.load(gvAllPath)[:,idt]
            agvgd  = np.load(gvGdPath)[:,idt]
...
dylim = {}
dylim['cc','mod']     = [0,1.2]
dylim['cc','heavy']   = [0,1.2]
dylim['cc','extreme'] = [0,1.2]

dylim['rain','mod']     = [0,15]
dylim['rain','heavy']   = [0,60]
dylim['rain','extreme'] = [0,80]

dylim['bias','mod']     = [-20,20]
dylim['bias','heavy']   = [-60,60]
dylim['bias','extreme'] = [-80,80]

dylim['brat','mod']     = [-230,230]
dylim['brat','heavy']   = [-230,230]
dylim['brat','extreme'] = [-230,230]

dylim['rmse','mod']     = [0,20]
dylim['rmse','heavy']   = [0,60]
dylim['rmse','extreme'] = [0,80]
...
#dylim = {'cc':[0,1.2], 'rmse':[0,10], 'bias':[-10,10],'rain':[0,0.25]}
