...
for (ullat,ullon) in llatlon:
    ...
    LatUp  = arange(lat0+0.05,lat1-0.05+0.01,0.1)
    LonUp  = arange(lon0+0.05,lon1-0.05+0.01,0.1)
...
#-- Save ---
outDir = tankbaseDir + '/utsumi/PMM/validprof/const'
outPath= outDir + '/orog.meter.sp.dec.1800x3600.npy'
