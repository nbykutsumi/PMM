...
def mk_la2comb(tag_comb):
  if tag_comb == "tc.comb":
    a2sum_tc1, a2sum_tc2 = ret_la2clim("tc","sum")
    a2sum_te1, a2sum_te2 = ret_la2clim("te","sum")
    a2sum_tf1, a2sum_tf2 = ret_la2clim("tf","sum")
    a2sum_tef1, a2sum_tef2 = ret_la2clim("tef","sum")

    a2num_tc   = ret_la2clim("tc","num")
    a2num_te   = ret_la2clim("te","num")
    a2num_tf   = ret_la2clim("tf","num")
    a2num_tef  = ret_la2clim("tef","num")
    a2num_pln  = ret_la2clim("plain","num")
    ...
    a2sum_c1, a2sum_c2 = ret_la2clim("c","sum")
    a2sum_fbc1, a2sum_fbc2 = ret_la2clim("fbc","sum")
    a2sum_ef1, a2sum_ef2 = ret_la2clim("ef","sum")
    a2sum_te1, a2sum_te2 = ret_la2clim("te","sum")
    a2sum_tf1, a2sum_tf2 = ret_la2clim("tf","sum")
    a2sum_tef1, a2sum_tef2 = ret_la2clim("tef","sum")

    a2num_c   = ret_la2clim("c","num")
    a2num_fbc = ret_la2clim("fbc","num")
    a2num_ef  = ret_la2clim("ef","num")
    a2num_te  = ret_la2clim("te","num")
    a2num_tf  = ret_la2clim("tf","num")
    a2num_tef = ret_la2clim("tef","num")
    a2num_pln = ret_la2clim("plain","num")
  ...
  for season in lseason:
    for tag in ["plain","ot"] + ltag_comb:
      ...
      for sumnum in ["amt","rat"]:
        ...
        ctrack_fig.mk_map(a2dat1,bnd=bnd, mycm="jet",soname=figname1, stitle=stitle1, cbarname=cbarname, miss=miss, lllat=lllat, lllon=lllon, urlat=urlat, urlon=urlon, a2shade=a2shade, coef=coef)
        ctrack_fig.mk_map(a2dat2,bnd=bnd, mycm="jet",soname=figname2, stitle=stitle2, cbarname=cbarname, miss=miss, lllat=lllat, lllon=lllon, urlat=urlat, urlon=urlon, a2shade=a2shade, coef=coef)
        print figname2
#  
...
#for tag in ltag:
  a2dat1, a2dat2 = ret_la2clim(tag,"amt")
